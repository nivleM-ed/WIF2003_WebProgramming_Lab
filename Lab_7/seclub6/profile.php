...
<?php 
session_start();
$_SESSION['array'] = json_decode(file_get_contents('seclubmember.txt'), true);
?>
                ...
                <div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td><?php echo $_SESSION["array"]["uname"]?></td>
                        </tr>
                        <tr>
                            <td><strong>Student ID:</strong></td>
                            <td><?php echo $_SESSION["array"]['studentID']?></td>
                        </tr>
                        <tr>
                            <td><strong>Email:</strong></td>
                            <td><?php echo $_SESSION["array"]["email"]?></td>
                        </tr>
                        <tr>
                            <td><strong>Birthday:</strong></td>
                            <td><?php echo $_SESSION["array"]["birthday"]?></td>
                        </tr>
                        <tr>
                            <td><strong>Most favourite event:</strong></td>
                            <td><?php echo $_SESSION["array"]["event"]?></td>
                        </tr>
                    </table>
                </div>
            </main>
